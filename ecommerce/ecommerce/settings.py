...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',# static file for deployment 
...
# EMAIL_HOST_PASSWORD = config('BREVO_EMAIL_PASSWORD')

# DEFAULT_FROM_EMAIL = config('BREVO_EMAIL_USER')
